...
class ThrowSessionExceptionClass {
  AllSessionsFetchedSuccessfully(data: any): never {
    throw createCustomException(
      SessionResponseCode.ALL_SESSIONS_FETCHED_SUCCESSFULLY,
      200,
      data,
    );
  }
  ...
  AllSessionsDestroyedSuccessfully(): never {
    throw createCustomException(
      SessionResponseCode.ALL_SESSIONS_DESTROYED_SUCCESSFULLY,
      200,
    );
  }
  ...
  SessionStatusFetchedSuccessfully(isSessionActive: boolean): never {
    throw createCustomException(
      SessionResponseCode.SESSION_STATUS_FETCHED_SUCCESSFULLY,
      200,
      isSessionActive,
    );
  }
  ...
  UserInfoFetchedSuccessfully(user: any): never {
    throw createCustomException(
      SessionResponseCode.USER_INFO_FETCHED_SUCCESSFULLY,
      200,
      user,
    );
  }
